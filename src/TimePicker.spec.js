...
describe('<DateTimePicker />', () => {
  it('supports controlled mode', () => {
    const tree = mount(<DateTimePicker value={new Date(2017, 10, 15, 13, 37, 0, 0)} mode='24h' />)
  ...
  describe('uncontrolled mode', () => {
    ...
    it('supports uncontrolled mode with a default value', () => {
      const tree = mount(<DateTimePicker defaultValue={new Date(2017, 10, 15, 13, 37, 0, 0)} mode='24h' />)
      expect(tree.findWhere((e) => e.type() === 'div' && testUtils.hasClass(/^TimePicker-header-/)(e)).text()).toBe('13:37')
    })

    it('uses the current time if no value or default value is set', () => {
      MockDate.set(new Date(2017, 10, 15, 13, 37, 0, 0))
      const tree = mount(<DateTimePicker mode='24h' />)
      expect(tree.findWhere((e) => e.type() === 'div' && testUtils.hasClass(/^TimePicker-header-/)(e)).text()).toBe('13:37')
    })
  })
  ...
  describe('12h', () => {
    it('matches the snapshot', () => {
      ...
      const tree = mount(
        <DateTimePicker mode='12h' value={new Date('2017-10-15T13:37Z')} />
      )
    ...
    it('starts with the hour selection', () => {
      ...
      const tree = mount(
        <DateTimePicker mode='12h' value={date} />
      )
    ...
    it('changes the value and the clock mode correctly', () => {
      ...
      const date = new Date(2017, 10, 15, 13, 37, 0, 0)
      const tree = mount(
        <DateTimePicker mode='12h' value={date} onChange={changeHandler} />
      )
    ...
    it('calls onMinutesSelected after selecting the minutes', () => {
      ...
      const tree = mount(
        <DateTimePicker mode='12h' onMinutesSelected={onMinutesSelected} />
      )
      getClock(tree).findWhere((e) => e.type() === 'div' && testUtils.hasClass(/^Clock-circle/)(e))
        .simulate('click', testUtils.stubClickEvent(128, 30)) // click on 12
        .simulate('mouseup', testUtils.stubClickEvent(128, 30)) // click on 12
    ...
    it('can toggle between editing the hours and the minutes', () => {
      const tree = mount(
        <DateTimePicker mode='12h' value={new Date(2017, 10, 15, 13, 37, 0, 0)} />
      )
    ...
    it('supports toggling between am and pm', () => {
      const changeHandler = jest.fn()
      let tree = mount(
        <DateTimePicker mode='12h' value={new Date(2017, 10, 15, 13, 37, 0, 0)} onChange={changeHandler} />
      )
      ...
      tree = mount(
        <DateTimePicker mode='12h' value={new Date(2017, 10, 15, 1, 37, 0, 0)} onChange={changeHandler} />
      )
      // 01:37 = 1:37 am --> 01:37
      changeHandler.mockClear()
      tree.findWhere((e) => e != null && e.getDOMNode() != null && e.text() === 'AM')
    ...
    it('does not switch from am to pm when selecting 12 hours', () => {
      const changeHandler = jest.fn()
      let tree = mount(
        <DateTimePicker mode='12h' value={new Date(2017, 10, 15, 1, 23, 0, 0)} onChange={changeHandler} />
      )
  ...
  describe('24h', () => {
    it('matches the snapshot', () => {
      ...
      Date.prototype.getHours = Date.prototype.getUTCHours // eslint-disable-line
      const tree = mount(
        <DateTimePicker mode='24h' value={new Date('2017-10-15T13:37Z')} />
      )
      expect(tree).toMatchSnapshot()
      Date.prototype.getHours = originalGetHours // eslint-disable-line
    })
    ...
    it('starts with the hour selection', () => {
      const date = new Date(2017, 10, 15, 13, 37, 0, 0)
      const tree = mount(
        <DateTimePicker mode='24h' value={date} />
      )
      const clock = getClock(tree)
    ...
    it('changes the value and the clock mode correctly', () => {
      ...
      const date = new Date(2017, 10, 15, 13, 37, 0, 0)
      const tree = mount(
        <DateTimePicker mode='24h' value={date} onChange={changeHandler} />
      )
    ...
    it('calls onMinutesSelected after selecting the minutes', () => {
      ...
      const onMinutesSelected = jest.fn()
      const tree = mount(
        <DateTimePicker mode='24h' onMinutesSelected={onMinutesSelected} />
      )
      getClock(tree).findWhere((e) => e.type() === 'div' && testUtils.hasClass(/^Clock-circle/)(e))
        .simulate('click', testUtils.stubClickEvent(128, 30)) // click on 12
        .simulate('mouseup', testUtils.stubClickEvent(128, 30)) // click on 12
    ...
    it('can toggle between editing the hours and the minutes', () => {
      const tree = mount(
        <DateTimePicker mode='24h' value={new Date(2017, 10, 15, 13, 37, 0, 0)} />
      )
