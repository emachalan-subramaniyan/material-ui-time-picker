  ...
  function TimePickerComponent(props) {
    ...
    _this.onHandleUpPress = function (data, part) {
      if (data === 'start' && part === 'hours') {
        ...
        } else if (_this.state.endsession === 'PM' && _this.props.restrictToDayTime && _this.props.restrictTime && _this.props.restrictTime.endtime > _this.state.endhours) {} else {
          _this.setState({
    ...
    _this.onHandleDownPress = function (data, part) {
      if (data === 'start' && part === 'hours') {
        ...
        console.log('this.state.starthours', _this.state.startdate, _this.state.enddate);

        if (_this.state.startdate === _this.state.enddate && _this.state.startsession === _this.state.endsession && _this.state.starthours >= _this.state.endhours) {
