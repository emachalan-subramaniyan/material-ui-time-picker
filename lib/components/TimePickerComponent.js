...
var TimePickerComponent = /*#__PURE__*/function (_React$Component) {
  ...
  function TimePickerComponent(props) {
    ...
    _this.onNowPress = function (data) {
      ...
      if (_this.props.restrictTime && _this.props.restrictTime.endtime < times.getHours()) {
    ...
    _this.onHandleUpPress = function (data, part) {
      if (data === 'start' && part === 'hours') {
        ...
        } else if (_this.state.startdate === _this.state.enddate && _this.props.timemode && parseInt(_this.props.timemode) === 24 && _this.props.restrictTime && _this.props.restrictTime.endtime - 1 <= _this.state.starthours) {} else {
          _this.setState({
    ...
    _this.state = {
      ...
      endhours: props.selectedTime && props.selectedTime.starttime ? _this.getSelectedValue('endhour') : _this.getinitialState("time"),
      startminutes: props.selectedTime && props.selectedTime.starttime ? _this.getSelectedValue('startminute') : _time.getMinutes(),
      endminutes: props.selectedTime && props.selectedTime.starttime ? _this.getSelectedValue('endminute') : _time.getMinutes(),
      ...
      endsession: props.selectedTime && props.selectedTime.starttime ? _this.getSelectedValue('endsession') : _this.getinitialState("session"),
      opendate: false,
      opentime: false,
