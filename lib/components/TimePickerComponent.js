...
var TimePickerComponent = /*#__PURE__*/function (_React$Component) {
  ...
  function TimePickerComponent(props) {
    ...
    _this.onNowPress = function (data) {
      ...
      if (_this.props.restrictTime) {
        if (_this.props.restrictTime.starttime < times.getHours() && _this.props.restrictTime.endtime > times.getHours()) {
          if (data === "start") {
            if (_this.props.timemode && parseInt(_this.props.timemode) === 24) {
              _this.setState({
    ...
    _this.onTimePress = function (data) {
      if (_this.props.restrictTime) {
        if (_this.props.restrictTime.starttime < 12 && _this.props.restrictTime.endtime > 12) {
          if (data === "start") {
            _this.setState({
              starthours: 12,
              startminutes: 0,
