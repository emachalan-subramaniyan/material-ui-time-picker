...
var DateRangePicker = function DateRangePicker(props) {
  ...
  React.useEffect(function () {
    if (insertedStartDate) {
      var date = insertedStartDate.split("/")[0];
      var month = insertedStartDate.split("/")[1];
      var year = insertedStartDate.split("/")[2];
  ...
  React.useEffect(function () {
    if (insertedEndDate) {
      var date = insertedEndDate.split("/")[0];
      var month = insertedEndDate.split("/")[1];
      var year = insertedEndDate.split("/")[2];
      var newDate = month + '/' + date + '/' + year;
  ...
  React.useEffect(function () {
    if (insertedStartDate && insertedEndDate) {
      var startdate = insertedStartDate.split("/")[0];
      var startmonth = insertedStartDate.split("/")[1];
      var startyear = insertedStartDate.split("/")[2];
      var enddate = insertedEndDate.split("/")[0];
      var endmonth = insertedEndDate.split("/")[1];
      var endyear = insertedEndDate.split("/")[2];
